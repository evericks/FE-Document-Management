...
@Component({
    selector: 'classify-header',
    templateUrl: './classify-header.component.html',
    standalone: true,
...
export class ClassifyHeaderComponent implements OnInit {
    ...
    onEditButtonClicked(data) {
        this._router.navigate(['/incoming-documents/classify', data.id]);
    }
}
